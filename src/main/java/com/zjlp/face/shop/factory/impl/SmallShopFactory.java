...
/**
 * 微小店生产
 * @ClassName: SmallShopFactory 
 * @Description: (微小店生产) 
 * @author ah
 * @date 2015年1月5日 下午2:29:10
 */
@Service("smallShopFactory")
public class SmallShopFactory implements ShopFactory {
