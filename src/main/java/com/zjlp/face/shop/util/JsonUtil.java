...
public class JsonUtil {
	...
	public static Map readValue(String json) throws JsonParseException,
			JsonMappingException, IOException {
		return (Map) om.readValue(json, Map.class);
	}

	public static void writeValue(Writer out, Map map)
	...
	public static JsonObject json2Object(String json) {
		...
		if ((json.trim().indexOf("{") < 0) || (json.trim().indexOf("}") < 0)) {
			json = "{}";
		}
	...
	public static void main(String[] args) {
		System.out.println(json2Object("{'articleId':44,'title':'应罗马尼亚总理蓬塔、'}")
				.get("title").toString().replaceAll("\"", ""));
	}
}